    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Indig-Tours uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'fc924dd3-6f42-4ad0-b8c0-2c419ee7993c',
                    name: data.name || '',
                    email: data.email || '',
